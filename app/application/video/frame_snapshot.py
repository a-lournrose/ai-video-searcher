...
from app.application.video.frame_iterator import VIDEO_PATH
...
def extract_frame_by_timestamp(
    ...
    Использует VIDEO_PATH по умолчанию, если video_path не передан.
...
def save_frame_with_optional_bbox(
    ...
    """
    frame = extract_frame_by_timestamp(timestamp_sec, video_path=video_path)
